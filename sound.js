...
let sound = new Sound(document.querySelector("#sound-div")),
    backgroundSound =  sound.create("assets/sounds/sample.mp3", "background_sound", true),
    movesSound = sound.create("assets/sounds/sample.mp3", "moves_sound"),
    dropSound = sound.create("assets/sounds/sample.mp3", "drop_sound"),
    pointsSound = sound.create("assets/sounds/sample.mp3", "points_sound"),
    finishSound = sound.create("assets/sounds/sample.mp3", "finish_sound");;
sound.muteToggle();
sound.soundSetting();
